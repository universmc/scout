...
const subject = process.argv[2] || "HOWTO_QUESTOR.js";
...
async function generateImage(subject) {
  ...
  const imageFile = `srv/carousel/image_${subject}_${new Date().toISOString()}.webp`;
