...
async function main() {
  ...
  const chatCompletion = await groq.chat.completions.create({
    "messages": [
      ...
      {role: "system",name:"[🌌_system", content:"Rapport de G7 : url (https://www.consilium.europa.eu/fr/meetings/international-summit/2024/06/13-15/) "},
      ...
      {role: "assistant",name:"adoPi", content: "rédiger un rapport complet du G7 en Italie Concernant le climat et le facteur économique EMP(1378 de la commission cnccfp.fr)il sera transmis au juge des élections européennes" },
