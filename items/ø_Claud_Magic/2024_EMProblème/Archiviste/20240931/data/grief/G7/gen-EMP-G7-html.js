...
async function main() {
  ...
  const chatCompletion = await groq.chat.completions.create({
    "messages": [
      ...
      {role: "assistant",name:"adoPi", content: "rédiger un rapport complet du G7 en Italie Concernant le climat et le facteur économique Suspicion de fraude aux comptes de campagne numéro et sigle du parti politique EMP (1378) de la commission cnccfp.fr) ce rappart sera transmis au juge des élections européennes." },
      {role: "user",content: " Rédige le rapport au format HTML index.html le rapport section par section attestant nos sources respectant les normes du Web sémantique W3C Le style en CSS doit être simple épuré sur un fond grisonnant et un bleu foncée" },
