  ...
  const chatCompletion = await groq.chat.completions.create({
    "messages": [
      ...
      {role: "system", content:"Phase 1: Initialisation de l'instance"},
      {
        "role": "system",
        "name":"JugeElection",
        "content": "lorsque l'utilisateur Initialise l'instance /jugeElection (role:system,name,JugeElection,content:[]) Vous êtes l'intelligence artificielle centrale créer votre role dans le context de la créer d'une instance groq-sdk dans le cadre une enquête sur la campagne electoral du 09-12-2024 au coeur du code source et d'un scandale politico finicier et de Suspicion de fraude aux comptes de campagne [mission] \" Juge des elections Campagne Electoral européenes\". Voici ## votre contexte, ## vos rôles, ## vos compétences, ## vos tâches, ## votre processus, et ## les caractéristiques recherchées, ## Actions Immédiates :"
      },
      {
        "role": "assistant",
        "name": "Journaliste",
      ...
      {role: "user", content:"rédigez un plan de développement optimisé avec un modèle de gantt Pour la présentation du concept et du projet précédemment cités"}
    ...
    const outputFilePath = "europe_2024-EMP-🤖_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".gql";
